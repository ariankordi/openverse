...
// Start of header?><!DOCTYPE html><html>
<head>
    <meta charset="utf-8">
...
<li id="global-menu-my-menu"><button class="symbol js-open-global-my-menu open-global-my-menu" id="my-menu-btn"></button>
 <menu id="global-my-menu" class="invisible none">
  ...
  <li><a href="/titles/3/3" class="symbol my-menu-info"><span>Openverse Announcements</span></a></li>
  <li><a href="/titles/3/4" class="symbol my-menu-info"><span>Openverse Changelog</span></a></li>
...
// End of header
function openFoot() { global $has_pjax; ?></div><div id="footer"><div id="footer-inner"><div class="link-container"><p><a href="https://www.pf2m.com/">PF2M's Website</a></p><p><a href="https://www.pf2m.com/contact/">Contact Us</a></p><p><a href="https://www.paypal.me/PF2M">Donate</a></p><p id="copyright"><a href="https://miiverse.nintendo.net/">Openverse is not-for-profit and is not associated with Miiverse, Nintendo, or Hatena.</a><br><a href="https://www.myhostblast.com/aff.php?aff=6394">Website hosted by HostBlast (for now), sign up today and get unlimited web hosting for as low as $1/mo!</a></p></div></div></div></div><?php if(!$has_pjax) { ?></body></html><?php }}
...
function openNoContentWindow($text = '') {
?><div class="no-content"><p><?=$text?></p></div><?php
}
